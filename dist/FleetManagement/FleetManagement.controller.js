...
const getFleetManagement = async (c) => {
    ...
    const FleetManagement = await (0, FleetManagement_service_1.getFleetManagementervice)(id);
...
const updateFleetManagement = async (c) => {
    ...
    try {
        ...
        const searchedFleetManagement = await (0, FleetManagement_service_1.getFleetManagementervice)(id);
...
const deleteFleetManagement = async (c) => {
    ...
    try {
        ...
        const res = await (0, FleetManagement_service_1.deleteFleetManagementervice)(id);
        if (!res)
